...
Haplotype::Haplotype(string lt): h(lt.size()), locus_type(lt)
{
...
Haplotype::Haplotype(Haplotype const & h2) : h(h2.h), locus_type(h2.locus_type)
{
...
Haplotype::Haplotype(const Haplotype & h2, int firstlocus, int lastlocus): h(h2.h.begin()+firstlocus,h2.h.begin()+lastlocus), locus_type(h2.locus_type.begin()+firstlocus,h2.locus_type.begin()+lastlocus)
{
    NHAP++;
}

// construct a haplotype out of two haplotypes
Haplotype::Haplotype(const Haplotype & h1, const Haplotype & h2): h(h1.h), locus_type(h1.locus_type+h2.locus_type)
{
...
{
    int d=0;
    for(unsigned l = 0; l < h1.get_nloci(); l++)
